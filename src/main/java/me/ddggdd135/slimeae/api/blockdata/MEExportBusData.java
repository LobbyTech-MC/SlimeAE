...
public class MEExportBusData extends MEBusData implements IInventoryBlockData {
    private static final NamespacedKey key = new NamespacedKey(SlimeAEPlugin.getInstance(), "me_export_bus");
    ...
    public boolean equals(Object o) {
        ...
        MEExportBusData that = (MEExportBusData) o;
