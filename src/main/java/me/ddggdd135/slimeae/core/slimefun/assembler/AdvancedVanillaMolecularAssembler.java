...
public class AdvancedVanillaMolecularAssembler extends VanillaMolecularAssembler {
    private final int defaultSpeed;

    public AdvancedVanillaMolecularAssembler(
    ...
    public int getSpeed(@Nonnull Block block) {
        ...
        return (int) ((MolecularAssembler.calcAccelerationSpeed(amount) / 1.5 + 1) * defaultSpeed);
    }
}
