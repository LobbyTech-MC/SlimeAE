...
import me.ddggdd135.slimeae.core.slimefun.CardInserterMachine;
...
import me.ddggdd135.slimeae.core.slimefun.MECellWorkbench;
import me.ddggdd135.slimeae.core.slimefun.MECleaner;
import me.ddggdd135.slimeae.core.slimefun.MEController;
import me.ddggdd135.slimeae.core.slimefun.MEConversionMonitor;
...
import me.ddggdd135.slimeae.core.slimefun.MaterialReskinMachine;
import me.ddggdd135.slimeae.core.slimefun.NetworksExpansionSwitch;
import me.ddggdd135.slimeae.core.slimefun.NotPlaceableItem;
import me.ddggdd135.slimeae.core.slimefun.ParallelDriver;
import me.ddggdd135.slimeae.core.slimefun.Pattern;
import me.ddggdd135.slimeae.core.slimefun.PatternResetMachine;
import me.ddggdd135.slimeae.core.slimefun.PatternWorkbench;
import me.ddggdd135.slimeae.core.slimefun.assembler.AdvancedLargeMolecularAssembler;
import me.ddggdd135.slimeae.core.slimefun.assembler.AdvancedMolecularAssembler;
import me.ddggdd135.slimeae.core.slimefun.assembler.AdvancedVanillaMolecularAssembler;
...
import me.ddggdd135.slimeae.core.slimefun.assembler.VanillaMolecularAssembler;
...
import me.ddggdd135.slimeae.core.slimefun.buses.MEChainedIEBus;
import me.ddggdd135.slimeae.core.slimefun.buses.MEChainedImportBus;
...
import me.ddggdd135.slimeae.core.slimefun.cards.UltimateAccelerationCard;
import me.ddggdd135.slimeae.core.slimefun.terminals.MEAllInOneTerminal;
...
import me.ddggdd135.slimeae.core.slimefun.terminals.MEPatternManagementTerminal;
...
import me.ddggdd135.slimeae.core.slimefun.terminals.MEVanillaPatternTerminal;
import me.ddggdd135.slimeae.core.slimefun.tools.CardReplicator;
import me.ddggdd135.slimeae.core.slimefun.tools.ChargedStaff;
import me.ddggdd135.slimeae.core.slimefun.tools.EntropyManipulator;
...
public class SlimeAEItems {
    ...
    public static final SlimefunItemStack ME_CELL_WORKBENCH = new SlimefunItemStack(
            "ME_CELL_WORKBENCH",
            new AdvancedCustomItemStack(
                    Material.CRAFTING_TABLE, "&d能源传输元件工作台", "", "{#3366ff>}用于修改存储元件的 黑/白 名单等{#33ccf3<}"));
    ...
    public static final SlimefunItemStack MOLECULAR_ASSEMBLER = new SlimefunItemStack(
            ...
            new AdvancedCustomItemStack(
                    ...
                    "&f分子装配室",
                    "",
                    "{#3366ff>}在自动合成中充当粘液合成台{#33ccf3<}",
                    "{#3366ff>}需要放在ME接口旁边 且只能用于AE的自动合成{#33ccf3<}",
                    "&a每个AE网络中 每个合成任务最多只会使用16384个合成设备"));
    ...
    public static final SlimefunItemStack ADVANCED_LARGE_MOLECULAR_ASSEMBLER_1 = new SlimefunItemStack(
            "ADVANCED_LARGE_MOLECULAR_ASSEMBLER_1",
            new AdvancedCustomItemStack(
                    Version.getCurrent().isEqualOrHigher(Version.v1_17_R1) ? Material.TINTED_GLASS : Material.GLASS,
                    "&c高级大型分子装配室 - Ⅰ",
                    "",
                    "{#3366ff>}放满加速卡的大型分子装配室{#33ccf3<}"));
    public static final SlimefunItemStack ADVANCED_LARGE_MOLECULAR_ASSEMBLER_2 = new SlimefunItemStack(
            "ADVANCED_LARGE_MOLECULAR_ASSEMBLER_2",
            new AdvancedCustomItemStack(
                    Version.getCurrent().isEqualOrHigher(Version.v1_17_R1) ? Material.TINTED_GLASS : Material.GLASS,
                    "&c高级大型分子装配室 - Ⅱ",
                    "",
                    "{#3366ff>}套娃大型分子装配室{#33ccf3<}"));
    ...
    public static final SlimefunItemStack VANILLA_MOLECULAR_ASSEMBLER = new SlimefunItemStack(
            "VANILLA_MOLECULAR_ASSEMBLER",
            new AdvancedCustomItemStack(
                    Version.getCurrent().isEqualOrHigher(Version.v1_17_R1) ? Material.TINTED_GLASS : Material.GLASS,
                    "&f原版分子装配室",
                    "",
                    "{#3366ff>}在自动合成中充当原版合成设备{#33ccf3<}",
                    "{#3366ff>}支持工作台/熔炉/高炉/烟熏炉/切石机{#33ccf3<}"));
    public static final SlimefunItemStack ADVANCED_VANILLA_MOLECULAR_ASSEMBLER_1 = new SlimefunItemStack(
            "ADVANCED_VANILLA_MOLECULAR_ASSEMBLER_1",
            new AdvancedCustomItemStack(
                    Version.getCurrent().isEqualOrHigher(Version.v1_17_R1) ? Material.TINTED_GLASS : Material.GLASS,
                    "&c高级原版分子装配室 - Ⅰ",
                    "",
                    "{#3366ff>}放满加速卡的原版分子装配室{#33ccf3<}"));
    public static final SlimefunItemStack ADVANCED_VANILLA_MOLECULAR_ASSEMBLER_2 = new SlimefunItemStack(
            "ADVANCED_VANILLA_MOLECULAR_ASSEMBLER_2",
            new AdvancedCustomItemStack(
                    Version.getCurrent().isEqualOrHigher(Version.v1_17_R1) ? Material.TINTED_GLASS : Material.GLASS,
                    "&c高级原版分子装配室 - Ⅱ",
                    "",
                    "{#3366ff>}套娃原版分子装配室{#33ccf3<}"));
    ...
    public static final SlimefunItemStack ME_ALL_IN_ONE_TERMINAL = new SlimefunItemStack(
            ...
            new AdvancedCustomItemStack(Material.SEA_LANTERN, "&f能源传输综合终端", "", "{#3366ff>}左键/右键存取物品 中键下单合成{#33ccf3<}"));
    ...
    public static final SlimefunItemStack ME_VANILLA_PATTERN_TERMINAL = new SlimefunItemStack(
            "ME_VANILLA_PATTERN_TERMINAL",
            new AdvancedCustomItemStack(
                    Material.LOOM,
                    "&f能源传输原版样板终端",
                    "",
                    "{#3366ff>}可以制作原版配方的编码样板{#33ccf3<}",
                    "{#3366ff>}支持工作台/熔炉/高炉/烟熏炉/切石机{#33ccf3<}"));
    ...
    public static final SlimefunItemStack ME_ITEM_STORAGE_COMPONENT_64T = new SlimefunItemStack(
            "ME_ITEM_STORAGE_COMPONENT_64T", new AdvancedCustomItemStack(Material.NETHER_STAR, "{#33aaf7}64t-能源传输存储组件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_COMPONENT_256T = new SlimefunItemStack(
            "ME_ITEM_STORAGE_COMPONENT_256T",
            new AdvancedCustomItemStack(Material.NETHER_STAR, "{#33aaf7}256t-能源传输存储组件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_COMPONENT_1P = new SlimefunItemStack(
            "ME_ITEM_STORAGE_COMPONENT_1P", new AdvancedCustomItemStack(Material.NETHER_STAR, "{#33aaf7}1p-能源传输存储组件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_COMPONENT_INFINITY = new SlimefunItemStack(
            ...
            new AdvancedCustomItemStack(Material.NETHERITE_BLOCK, "&c无&6尽&e能源传输&a存&9储&c组&6件"));
    ...
    public static final SlimefunItemStack ME_ITEM_STORAGE_CELL_64T = new SlimefunItemStack(
            ...
            new AdvancedCustomItemStack(Material.MUSIC_DISC_PIGSTEP, "{#33aaf7}64t-能源传输存储元件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_CELL_256T = new SlimefunItemStack(
            "ME_ITEM_STORAGE_CELL_256T",
            new AdvancedCustomItemStack(Material.MUSIC_DISC_PIGSTEP, "{#33aaf7}256t-能源传输存储元件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_CELL_1P = new SlimefunItemStack(
            "ME_ITEM_STORAGE_CELL_1P", new AdvancedCustomItemStack(Material.MUSIC_DISC_PIGSTEP, "{#33aaf7}1p-能源传输存储元件"));
    public static final SlimefunItemStack ME_ITEM_STORAGE_CELL_INFINITY = new SlimefunItemStack(
            "ME_ITEM_STORAGE_CELL_INFINITY",
            new AdvancedCustomItemStack(Material.MUSIC_DISC_5, "&c无&6尽&e能源传输&a存&9储&c元&6件"));
    ...
    public static final SlimefunItemStack CARD_INSERTER = new SlimefunItemStack(
            "CARD_INSERTER",
            new AdvancedCustomItemStack(Material.DISPENSER, "&e塞卡器", "", "&e自动/手动为能源传输内机器插入升级卡", "&e支持从能源传输网络读取卡"));
    ...
    public static void onSetup(SlimeAEPlugin plugin) {
        ...
        new LargeMolecularAssembler(
                ...
                .register(plugin);
        new AdvancedLargeMolecularAssembler(
                        SlimeAEItemGroups.MACHINE,
                        ADVANCED_LARGE_MOLECULAR_ASSEMBLER_1,
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
        ...
        new VanillaMolecularAssembler(
                ...
                .register(plugin);
        new AdvancedVanillaMolecularAssembler(
                        SlimeAEItemGroups.MACHINE,
                        ADVANCED_VANILLA_MOLECULAR_ASSEMBLER_1,
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
